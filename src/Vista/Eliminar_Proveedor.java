...
public class Eliminar_Proveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnListar.setText("Buscar Proveedores");
        ...
        btnEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/eliminate.png"))); // NOI18N
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int filaInicio = Datos_Proveedor.getSelectedRow();
        int numFS = Datos_Proveedor.getSelectedRowCount();
        ArrayList<String> listIdProveedor = new ArrayList();
        String idProveedor = "";
        if (filaInicio >= 0) {
            for (int i = 0; i < numFS; i++) {
                idProveedor = String.valueOf(Datos_Proveedor.getValueAt(i + filaInicio, 0));
                listIdProveedor.add(idProveedor);
            }
            System.out.println(listIdProveedor);

            for (int i = 0; i < numFS; i++) {
                int rptaUsuario = JOptionPane.showConfirmDialog(null, "¿Quiere eliminar el registro con id=" + idProveedor + "?");
                if (rptaUsuario == 0) {
                    proveedor.eliminarProveedor(Integer.parseInt(idProveedor));
                }
            }
            LlenarTabla(Datos_Proveedor);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eliminar_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
